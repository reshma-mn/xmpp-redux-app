            ...
            <Text>you are in</Text>
                ...
                <View style={styles.messageBar}>
                    ...
                    <View style={styles.sendButton}>
                        <TouchableOpacity onPress={()=>{xmpp.sendMessage(this.state.message);this.setState({message:''})}} disabled={!this.state.message || !this.state.message.trim()}><Text>Send</Text></TouchableOpacity>
                    </View>
                </View>
